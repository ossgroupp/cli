...
function initNextJSSubscriptionCommerce({ answers, projectPath }) {
	// Update website .env file
	const envVarsWebsite = {
		NEXT_PUBLIC_OSSPIM_INSTANCE_IDENTIFIER: answers.instance,
		NEXT_PUBLIC_SERVICE_API_URL: 'https://api.photofinder.superfast.shop',
	};
	fs.writeFileSync(
...
module.exports = initNextJSSubscriptionCommerce;
